...
interface Exchange {
    ...
    privateGetApiV1AccountWithdraw (params?: {}): Promise<implicitReturnType>;
    privateGetApiV1Ping (params?: {}): Promise<implicitReturnType>;
    privateGetApiV1Time (params?: {}): Promise<implicitReturnType>;
